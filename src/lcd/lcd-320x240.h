...
extern void LCD_WriteMem(unsigned int addr, const u16 *data, unsigned int nitems);
extern void LCD_FillMem(unsigned int addr, const u16 data, unsigned int nitems);
...
extern void LCD_DrawCircle(int x, int y, int r, u16 color);
